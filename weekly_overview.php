...
// Função utilitária que garante que apenas funcionários (e não gerentes ou admins) acessem esta página.
// Se você já tiver uma função requireEmployee() na sua base de código, utilize-a. Caso contrário, esta é uma versão simples.
